...
public class SpreadPlayersCommand {
   ...
   private static int spreadPlayers(CommandSource source, Vec2f center, float spreadDistance, float maxRange, boolean respectTeams, Collection<? extends Entity> targets) throws CommandSyntaxException {
      ...
      func_198717_a(center, (double)spreadDistance, source.func_197023_e(), random, d0, d1, d2, d3, aspreadplayerscommand$position, respectTeams);
      double d4 = func_198719_a(targets, source.func_197023_e(), aspreadplayerscommand$position, respectTeams);
   ...
   private static void func_198717_a(Vec2f center, double spreadDistance, ServerWorld worldIn, Random random, double minX, double minZ, double maxX, double maxZ, SpreadPlayersCommand.Position[] positions, boolean respectTeams) throws CommandSyntaxException {
      boolean flag = true;
   ...
   private static double func_198719_a(Collection<? extends Entity> targets, ServerWorld worldIn, SpreadPlayersCommand.Position[] positions, boolean respectTeams) {
      double d0 = 0.0D;
      int i = 0;
