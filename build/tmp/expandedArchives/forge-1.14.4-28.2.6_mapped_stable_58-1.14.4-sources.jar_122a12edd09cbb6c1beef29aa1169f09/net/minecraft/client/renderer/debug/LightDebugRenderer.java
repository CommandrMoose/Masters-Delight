...
public class LightDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   public void render(long p_217676_1_) {
      ...
      for(BlockPos blockpos1 : BlockPos.getAllInBoxMutable(blockpos.add(-10, -10, -10), blockpos.add(10, 10, 10))) {
         ...
         if (longset.add(k)) {
            DebugRenderer.func_217729_a(world.getChunkProvider().func_212863_j_().func_215572_a(LightType.SKY, SectionPos.from(k)), (double)(SectionPos.extractX(k) * 16 + 8), (double)(SectionPos.extractY(k) * 16 + 8), (double)(SectionPos.extractZ(k) * 16 + 8), 16711680, 0.3F);
         }
