...
public class PositionTrigger implements ICriterionTrigger<PositionTrigger.Instance> {
   ...
   public void trigger(ServerPlayerEntity player) {
      ...
      if (positiontrigger$listeners != null) {
         positiontrigger$listeners.func_193462_a(player.func_71121_q(), player.posX, player.posY, player.posZ);
      }
   ...
   static class Listeners {
      ...
      public void func_193462_a(ServerWorld world, double x, double y, double z) {
         ...
         for(ICriterionTrigger.Listener<PositionTrigger.Instance> listener : this.listeners) {
            if (listener.getCriterionInstance().func_193204_a(world, x, y, z)) {
               if (list == null) {
