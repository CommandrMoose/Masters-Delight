...
public class NetherTravelTrigger implements ICriterionTrigger<NetherTravelTrigger.Instance> {
   ...
   public void trigger(ServerPlayerEntity player, Vec3d enteredNetherPosition) {
      ...
      if (nethertraveltrigger$listeners != null) {
         nethertraveltrigger$listeners.func_193483_a(player.func_71121_q(), enteredNetherPosition, player.posX, player.posY, player.posZ);
      }
   ...
   public static class Instance extends CriterionInstance {
      ...
      public boolean func_193206_a(ServerWorld world, Vec3d enteredNetherPosition, double x, double y, double z) {
   ...
   static class Listeners {
      ...
      public void func_193483_a(ServerWorld world, Vec3d enteredNetherPosition, double x, double y, double z) {
         ...
         for(ICriterionTrigger.Listener<NetherTravelTrigger.Instance> listener : this.listeners) {
            if (listener.getCriterionInstance().func_193206_a(world, enteredNetherPosition, x, y, z)) {
               if (list == null) {
