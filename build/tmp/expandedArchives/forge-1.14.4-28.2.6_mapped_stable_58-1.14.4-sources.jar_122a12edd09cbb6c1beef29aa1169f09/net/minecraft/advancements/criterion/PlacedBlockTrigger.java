...
public class PlacedBlockTrigger implements ICriterionTrigger<PlacedBlockTrigger.Instance> {
   ...
   public void trigger(ServerPlayerEntity player, BlockPos pos, ItemStack item) {
      ...
      if (placedblocktrigger$listeners != null) {
         placedblocktrigger$listeners.func_193489_a(blockstate, pos, player.func_71121_q(), item);
      }
   ...
   public static class Instance extends CriterionInstance {
      ...
      public boolean func_193210_a(BlockState state, BlockPos pos, ServerWorld world, ItemStack item) {
         if (this.block != null && state.getBlock() != this.block) {
            ...
            if (!this.location.func_193453_a(world, (float)pos.getX(), (float)pos.getY(), (float)pos.getZ())) {
               return false;
            } else {
   ...
   static class Listeners {
      ...
      public void func_193489_a(BlockState state, BlockPos pos, ServerWorld world, ItemStack item) {
         ...
         for(ICriterionTrigger.Listener<PlacedBlockTrigger.Instance> listener : this.listeners) {
            if (listener.getCriterionInstance().func_193210_a(state, pos, world, item)) {
               if (list == null) {
