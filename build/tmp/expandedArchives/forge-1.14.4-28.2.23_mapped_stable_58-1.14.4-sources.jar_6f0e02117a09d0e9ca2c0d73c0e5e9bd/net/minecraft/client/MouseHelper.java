...
public class MouseHelper {
   ...
   public void registerCallbacks(long handle) {
      InputMappings.setMouseCallbacks(handle, this::cursorPosCallback, this::mouseButtonCallback, this::scrollCallback);
   }
   ...
   public void grabMouse() {
      if (this.minecraft.isGameFocused()) {
         if (!this.mouseGrabbed) {
            ...
            InputMappings.setCursorPosAndMode(this.minecraft.mainWindow.getHandle(), 212995, this.mouseX, this.mouseY);
   ...
   public void ungrabMouse() {
      if (this.mouseGrabbed) {
         ...
         this.mouseX = (double)(this.minecraft.mainWindow.getWidth() / 2);
         this.mouseY = (double)(this.minecraft.mainWindow.getHeight() / 2);
         InputMappings.setCursorPosAndMode(this.minecraft.mainWindow.getHandle(), 212993, this.mouseX, this.mouseY);
      }
   }
}