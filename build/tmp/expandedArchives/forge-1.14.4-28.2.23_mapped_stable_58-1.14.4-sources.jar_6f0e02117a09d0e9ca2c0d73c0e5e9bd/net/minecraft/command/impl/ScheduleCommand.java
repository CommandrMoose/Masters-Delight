...
public class ScheduleCommand {
   ...
   private static int func_218908_a(CommandSource p_218908_0_, Either<FunctionObject, Tag<FunctionObject>> p_218908_1_, int p_218908_2_) throws CommandSyntaxException {
      if (p_218908_2_ == 0) {
         ...
         long i = p_218908_0_.func_197023_e().getGameTime() + (long)p_218908_2_;
         p_218908_1_.ifLeft((p_218910_4_) -> {
            ResourceLocation resourcelocation = p_218910_4_.getId();
            p_218908_0_.func_197023_e().getWorldInfo().getScheduledEvents().scheduleReplaceDuplicate(resourcelocation.toString(), i, new TimedFunction(resourcelocation));
            ...
            p_218908_0_.func_197023_e().getWorldInfo().getScheduledEvents().scheduleReplaceDuplicate("#" + resourcelocation.toString(), i, new TimedFunctionTag(resourcelocation));
