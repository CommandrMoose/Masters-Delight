...
public class MultiTask<E extends LivingEntity> extends Task<E> {
   ...
   protected boolean func_212834_g_(ServerWorld worldIn, E entityIn, long gameTimeIn) {
      return this.field_220419_e.func_220655_b().filter((p_220414_0_) -> {
         ...
         return p_220413_4_.func_212834_g_(worldIn, entityIn, gameTimeIn);
      });
   }
   ...
   protected void func_212833_d_(ServerWorld worldIn, E owner, long gameTime) {
      this.field_220419_e.func_220655_b().filter((p_220408_0_) -> {
         ...
         p_220409_4_.func_220377_c(worldIn, owner, gameTime);
      });
   }
   ...
   protected void func_212835_f_(ServerWorld worldIn, E entityIn, long gameTimeIn) {
      this.field_220419_e.func_220655_b().filter((p_220407_0_) -> {
         ...
         p_220412_4_.func_220380_e(worldIn, entityIn, gameTimeIn);
      });
      ...
      RUN_ONE {
         public <E extends LivingEntity> void func_220630_a(WeightedList<Task<? super E>> p_220630_1_, ServerWorld p_220630_2_, E p_220630_3_, long p_220630_4_) {
            p_220630_1_.func_220655_b().filter((p_220634_0_) -> {
               ...
               return p_220633_4_.func_220378_b(p_220630_2_, p_220630_3_, p_220630_4_);
            }).findFirst();
         }
      },
      TRY_ALL {
         public <E extends LivingEntity> void func_220630_a(WeightedList<Task<? super E>> p_220630_1_, ServerWorld p_220630_2_, E p_220630_3_, long p_220630_4_) {
            p_220630_1_.func_220655_b().filter((p_220632_0_) -> {
               ...
               p_220631_4_.func_220378_b(p_220630_2_, p_220630_3_, p_220630_4_);
            });
         }
      };
