...
public class WorldInfo {
   ...
   public void addToCrashReport(CrashReportCategory category) {
      category.func_189529_a("Level name", () -> {
         return this.levelName;
      });
      category.func_189529_a("Level seed", () -> {
         return String.valueOf(this.randomSeed);
      });
      category.func_189529_a("Level generator", () -> {
      ...
      category.func_189529_a("Level generator options", () -> {
